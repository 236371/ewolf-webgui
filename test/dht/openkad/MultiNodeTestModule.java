...
public class MultiNodeTestModule extends AbstractModule {
	...
	private Properties getDefaultProperties() {
		...
		defaultProps.setProperty("kad.bucketsize", "4");
		defaultProps.setProperty("kad.incomming.threadpoolsize", "2");
	...
	public MultiNodeTestModule() {
		this(new Properties());
	}
	
	public MultiNodeTestModule(Properties properties) {
	...
	KeyFactory provideKadKeyFactory(@Named("kad.keyfactory.seed") long seed) {
		return new TestKeyFactory(20, seed);
	}
	@Provides
